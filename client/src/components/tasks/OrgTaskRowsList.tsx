...
// Shared task-row rendering for both OrgPostRow and OrgHeadRow.
// Centralized so the status-change UX stays consistent across post-scope
// tasks and head-scope (department/section) tasks.
...
function getDateColorClass(dueDateStatus: string): string {
...
export default function OrgTaskRowsList({ tasks, onTaskClick, onTaskStatusChange, darkMode }: Props) {
