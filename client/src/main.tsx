...
if (typeof window !== 'undefined') {
  // Always claim the named-window target so the legacy target="sarcinator-app"
  // path keeps working in browsers where it still survives (in-browser clicks).
  ...
  if ('BroadcastChannel' in window) {
    ...
    if (isHandoffLandingPage && openTaskId) {
